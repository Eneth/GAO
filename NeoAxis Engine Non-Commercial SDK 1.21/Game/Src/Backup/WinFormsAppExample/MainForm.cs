	...
	public partial class MainForm : Form
	{
		...
		private void MainForm_Load( object sender, EventArgs e )
		{
			...
			if( !WinFormsAppWorld.Init( new ExampleEngineApp( EngineApp.ApplicationTypes.Simulation ), this,
				"user:Logs/WinFormsAppExample.log" ) )
		...
		void renderTargetUserControl1_Tick( float delta )
		{
		...
		private void buttonCreateBox_Click( object sender, EventArgs e )
		{
			...
			if( GameNetworkClient.Instance != null )
			{
				...
				string data = string.Format( "{0};{1};{2}", "Box",
					new Vec3( -3.40241f, -92.72477f, 7.815409f ), Quat.Identity );
			...
			else
			{
				...
				box.Position = new Vec3( -3.40241f, -92.72477f, 7.815409f );
				box.PostCreate();
			}
		}
